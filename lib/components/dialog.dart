...
class Dialog extends GameObject {
  ...
  Dialog(this.game) : super(game) {
    ...
    playButton = Rect.fromLTWH((game.viewport.width / 2) - buttonWidth / 2, wrapper.center.dy - 12.5, buttonWidth, buttonHeight);
    ...
    producerText = TextComponent(
      game,
      'Published by Alekhin Games',
      20.0,
      wrapper.bottom - (padding * .6),
      0xff6cb2eb,
    );
    children.add(producerText);
  }
